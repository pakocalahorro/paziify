# 🎙️ Guía Maestra de Audio - Paziify (v2.14.0) 💎

Esta guía documenta la arquitectura técnica del motor de audio, los protocolos de nomenclatura, el catálogo auditado y los parámetros de identidad de los guías. La versión **v2.14.0** consolida la migración a voces de ultra-alta definición (**Studio** y **Chirp3-HD**).
...
- **Aria (Femenina - Calm/Spiritual)**: `es-ES-Chirp3-HD-Vindemiatrix` | Pitch: 0.0 | Rate: 0.72 | [Muestra de Audio](https://ueuxjtyottluwkvdreqe.supabase.co/storage/v1/object/public/meditation-voices/samples/sample_aria_vindemiatrix.mp3)
- **Gaia (Infantil - Dulce)**: `es-ES-Chirp3-HD-Autonoe` | Pitch: 0.0 | Rate: 0.80 | [Muestra de Audio](https://ueuxjtyottluwkvdreqe.supabase.co/storage/v1/object/public/meditation-voices/samples/sample_gaia.mp3)
- **Ziro (Masculina - Power)**: `es-ES-Chirp3-HD-Enceladus` | Pitch: 0.0 | Rate: 0.75 | [Muestra de Audio](https://ueuxjtyottluwkvdreqe.supabase.co/storage/v1/object/public/meditation-voices/samples/sample_ziro.mp3)
...
*   **`generate_audiobook.py`**: El motor principal de síntesis. En su versión **v2.14.0** incluye:
    - **Chunking por Bytes**: Fragmentación automática para no superar los 5000 bytes de Google Cloud.
    - **Detección Dinámica**: Omite el `pitch` en voces Chirp/Studio para evitar errores de API.
    - **Quota Tracker**: Seguimiento local del consumo para el plan gratuito.
*   **`Utils/generate_audio_easy.bat`**: Lanzador simplificado para Windows. Permite arrastrar un `.txt` y elegir guía (Aria, Ziro, Gaia, Éter) para obtener el MP3 procesado al instante.
...
## 5. Auditoría de Sesiones (101 Guiadas)
...
---
*Última revisión: 21 de Febrero de 2026 - Versión 2.14.0 (Premium HD Overhaul)*

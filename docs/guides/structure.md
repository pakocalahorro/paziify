...
**Versión**: 2.44.0 (Admin Roles Stabilization)
**Última actualización**: 6 de Marzo de 2026

**Historial Reciente**:
- **v2.44.0**: Reparación Crítica de Guardado (RLS Admin Fix) y Shadow Sync Architectura para Panel Admin.
...
### 9. Panel de Administraci�n (CMS)

El CMS de Paziify está construido sobre **Refine + Ant Design**. Su misi�n es permitir al equipo de contenido gestionar el catálogo sin conocimientos t�cnicos.

#### Arquitectura " Shadow Sync\ (v2.44.0)
Debido a la migraci�n de contenidos a campos JSONB (para mayor flexibilidad), el Panel utiliza un sistema de **Sincronizaci�n en la Sombra**:
...
2. **Edici�n**: El usuario interactua con campos de texto y selectores normales.
3. **Transformaci�n**: El m�todo handleOnFinish (en el useForm de Refine) reconstruye los objetos JSON antes de la petici�n PATCH a Supabase.

#### Restricciones de Seguridad (RLS)
El Panel exige que el usuario tenga el rol dmin definido en la tabla public.profiles. Los cambios realizados por usuarios sin este rol serán rechazados silenciosamente por las pol�ticas de Supabase, devolviendo un 200 OK sin persistencia real.

---
*Última revisi�n: 6 de Marzo de 2026 - Versi�n 2.44.0*

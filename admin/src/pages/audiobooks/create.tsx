...
import { Form, Input, Select, Checkbox, AutoComplete, InputNumber, Divider, Typography, Button, Space, message } from "antd";
    ...
    return (
        <Create saveButtonProps={saveButtonProps}>
            ...
            >
                ...
                <Form.Item label="Image URL" name="image_url" rules={[{ required: true }]}>
                    <Input readOnly placeholder="Sube una portada abajo" />
                </Form.Item>
                <MediaUploader
